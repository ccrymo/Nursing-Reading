      ...
      <div className="bg-neutral-900 p-20 rounded-lg relative">
        ...
        <div className="flex flex-col space-y-4 ">
          <Link href="./components/Vocabulary">
            <button className="w-full  text-2xl font-bold py-3 px-6 rounded-lg bg-gradient-to-r from-neutral-800 to-neutral-900 hover:from-amber-400 hover:to-amber-600 hover:text-amber-950 text-white">
              Vocabulary
            </button>
          </Link>
